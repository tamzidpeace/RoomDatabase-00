...
public class AddName extends AppCompatActivity {
    ...
    public static final String DELETE_ALL = "com.example.android.wordlistsql.ALL_DELETE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button saveButton, deleteAllButton;
        ...
        deleteAllButton = findViewById(R.id.delte_all);
        ...
        deleteAllButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent deleteIntent = new Intent(AddName.this, MainActivity.class);
                deleteIntent.putExtra(DELETE_ALL, 1);
